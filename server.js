...
// ✅ Import Routes (⚠️ filenames EXACT match hone chahiye)
...
import messageRoutes from "./src/routes/messageRoutes.js";
import sendOTP from "./src/services/otpService.js"; // keep import (but not using as route)
import errorHandler from "./src/middleware/errorHandler.js";
...
// ❌ sendOTP ko direct route nahi use karna
// app.use("/api/otp", sendOTP);
